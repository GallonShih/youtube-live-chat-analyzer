...
def sample_messages_with_emojis(db):
    """Create sample messages with various emoji types."""
    ...
    messages = [
        ...
        ChatMessage(
            ...
            message=":ytEmote1: Hello :ytEmote2:",
            timestamp=1705320000000000,
            published_at=base_time,
            author_name="User1",
            author_id="user_1",
            emotes=[
                {"name": ":ytEmote1:", "images": [{"url": "https://example.com/yt1.png"}]},
                {"name": ":ytEmote2:", "images": [{"url": "https://example.com/yt2.png"}]}
            ]
        ),
        ...
        ChatMessage(
            message_id="msg_yt_2",
            live_stream_id="test_stream",
            message=":ytEmote1: Again!",
            timestamp=1705320060000000,
        ...
        ChatMessage(
            ...
            live_stream_id="test_stream",
            message=":ytEmote1: plus 🎉 mixed",
            timestamp=1705320240000000,
